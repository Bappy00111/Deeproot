          ...
          {pricingPlans.map((plan, idx) => (
            ...
            >
              ...
              <div>
                ...
                <p className="mt-4 text-[32px] font-sora font-bold">
                  {plan.label}
                </p>
                <div className="mt-1 flex items-baseline justify-center gap-1">
                  <span className="text-[#03fdad] text-5xl leading-none font-montserrat font-light text-[50px] xl:text-[74px]">
                    <span className="text-[40px] xl:text-[50px]">
                      {" "}
                      {plan.currency}
                    </span>
                    {plan.price}
                ...
                <p className="mt-1 text-xs md:text-sm opacity-70 font-montserrat font-light">
                  {plan.note}
                </p>
              </div>
              ...
              <ul className="mt-8 mb-6 space-y-3 text-xs leading-relaxed">
                {plan.features.map((feature, index) => (
                  <li
                    ...
                    className="flex items-start justify-center gap-2 font-roboto text-[14px] font-normal"
                  >
                    <span className="mt-[2px] text-white text-sm font-black">
                      ✔
                    </span>
                    <span className="text-left sm:text-center">{feature}</span>
                  </li>
                ))}
              </ul>
