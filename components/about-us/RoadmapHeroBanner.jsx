...
export default function RoadmapHeroBanner() {
  ...
  return (
    ...
    >
      ...
      <div className="app-container">
        {/* ✅ একটাই (solo) AOS: পুরো গ্রিড একসাথে animate */}
        <div
            ...
            >
              <div className="mb-6">
                <Image
                  ...
                  className="h-16 w-16 object-contain"
                  priority={false}
                  onLoad={() => AOS.refresh()} // ইমেজ লোডের পরে লেআউট ঠিক রাখতে
                />
              </div>

              <h3 className="text-xl  text-slate-900 font-round">{title}</h3>
              <p className="mt-3 text-[#3B4459] leading-relaxed font-normal  font-montserrat">
                {desc}
              </p>
