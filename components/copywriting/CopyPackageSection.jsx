...
// components/CopyPackageSection.jsx (বা .tsx)
"use client";
...
const plans = [
  {
    ...
    price: "500",
    label:
      "Our team of experts are here to generate Fourunique content for your business blog.",
    features: [
      "4 Blog Articles",
      "On-Page Optimization",
      "High Quality Backlinks",
                ...
                return (
                  <div
                    ...
                    className={`relative flex flex-col justify-between ${heightClass}
                      rounded-2xl px-7 py-[65px]
                      bg-slate-900/50 backdrop-blur-xl border border-slate-800/90
                    `}
                    data-aos="zoom-in"
                    data-aos-delay={index * 120} // 0, 120...
                    data-aos-duration="1800"
                  >
                    {/* Glow bar for highlighted card */}
                    {plan.highlight && (
                    ...
                    <div>
                      ...
                      <ul className="mt-7 space-y-2 text-xs text-[14px] font-light text-white font-roboto text-center">
                        {plan.features.map((f) => (
                          <li key={f} className="pb-4">
                            {/* <IoMdCheckmark className="inline h-4 w-4 mr-1" /> */}
                            <span>{f}</span>
                          </li>
                        ))}
                      </ul>
                    ...
                    <div className="mt-8 mx-auto">
                      <button
                        className={`px-4 lg:px-10 rounded-full py-3 text-sm font-normal font-montserrat cursor-pointer text-center transition
                          ${
                            plan.highlight
                              ? "bg-emerald-400 text-slate-950 hover:bg-emerald-300"
                              : "bg-slate-800/90 text-slate-100 hover:bg-slate-700"
