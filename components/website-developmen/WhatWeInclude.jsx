...
// components/website-developmen/WhatWeInclude.jsx
"use client";
...
export default function WhatWeInclude() {
  ...
  return (
    <section className="bg-white">
      <div
        className="app-container py-10 xl:py-16"
        data-aos="fade-up"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-start lg:items-center gap-10 lg:gap-16">
          ...
          <div className="flex flex-col md:flex-row items-start md:gap-8">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-base md:text-base leading-relaxed text-[#6a7282] max-w-xl font-popins tracking-wide">
                We include{" "}
                <span className="font-semibold text-[#726f6f]">ongoing support</span>{" "}
                and{" "}
                <span className="font-semibold text-[#726f6f]">maintenance</span>{" "}
                of your website,{" "}
                <span className="font-semibold text-[#726f6f]">a constant work</span>{" "}
                on keeping your website{" "}
                <span className="font-semibold text-[#726f6f]">securely and well-performed.</span>
              </p>
            </div>
          </div>
