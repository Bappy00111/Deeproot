...
// app/components/DeliverablesOverview.jsx
"use client";
...
export default function DeliverablesOverview() {
  ...
  return (
    <section className="bg-white">
      <div
        className="app-container py-10 xl:py-20 2xl:py-40"
        data-aos="fade-up"
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 items-center lg:items-start gap-10 lg:gap-16">
          {/* Left: Icon + Text */}
          <div className="flex flex-col md:flex-row items-start md:gap-8 xl:gap-12 order-2 md:order-1">
            <div className="w-16 h-16 bg-[#504992] flex justify-center items-center mx-auto md:mx-0 mb-6 md:mb-0 shrink-0">
              <FontAwesomeIcon icon={faConnectdevelop} className="text-white text-2xl" />
            </div>
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-base md:text-base leading-relaxed text-[#6a7282] max-w-xl font-popins tracking-wide">
                Imagine: You are a nonprofit organisation and wannt to run marketing campaign.
                If you can get Google Ads advertising budget worth $10,000 USD per month,
                what you can get from it? We can help you manage this Google Grants and take
                full advantage of it to make your website visible. Free ads for charities in Tasmania!
              </p>
            </div>
          </div>
          ...
          {/* Right: Image */}
          <div
            className="flex-1 flex justify-center lg:justify-end order-1 md:order-2"
            data-aos="zoom-in"
            data-aos-duration="1800"
            data-aos-delay="120"
          >
